     ...
     <div style={{transform:openModal1}} className="main_login_form  h-screen flex justify-center items-center fixed top-0 left-0">
        ...
        <div className="container flex justify-between  items-center ">
            <div className="nav_left_side">
              <a href='/'>  <img src="images/logo.png" alt="logo" className="h-[45px]  navLogo w-[160px]"/></a>
            </div>

                {
                    da?.email ? <a href={`/form?id=${da.userId}`} className="font-black usernameLogin text-xl ">
                   Hi {da.email.split("@")[0]}
                </a>:""
                }
