                        ...
                        <div classNmae="mt-8">
                          ...
                          <div className="mt-10">
                             ...
                             <div className="my-[30px]">
                                 <Link  onClick={goBack } href="" className="px-[30px] py-3 bg-black text-white">Back </Link>
                                 <Link onClick={()=> setProgressWidth('25%')} className="px-[20px] ml-3 py-3 bg-black text-white" href="/step-8">Save And Continue </Link>
                             </div>
