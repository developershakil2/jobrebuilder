...
const  StepFinal = ()=>{
  ...
  pdfUrl ? (
   <div className="w-[95%] flex justify-center items-center mx-auto">
       <Link className="w-[280px] px-10 py-3 rounded-lg  mx-auto my-6 text-center bg-black text-white" href={`/form?id=${da?.userId}`}>
...
{/* 
       <Link href="/edit" className="px-16 rounded-md bg-[#7E7E7E] py-3 text-white font-black text-xl">Edit</Link>
      */}
     </div>
