                        ...
                        <div classNmae="mt-8">
                          ...
                          <div className="mt-10">
                             ...
                             <div className="my-[30px]">
                                 <button  onClick={[goBack , setProgressWidth('10%')]}  className="px-[30px] outline-none border-none py-3 bg-black text-white">Back </button>
                                 <Link onClick={stepFunc} className="px-[20px] ml-3 py-3 bg-black text-white" href="/step-4">Save And Continue </Link>
                             </div>
